...
class _HomeState extends State<Home> with AutomaticKeepAliveClientMixin {
    ...
    return Container(
      ...
      child: Center(
        child: ListView.builder(
          ...
          itemCount: homeProvider?.top?.feed?.entries?.length ?? 0,
          shrinkWrap: true,
          itemBuilder: (BuildContext context, int index) {
            Entry entry = homeProvider.top.feed.entries[index];
            return Padding(
      ...
      child: Center(
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            String title = homeProvider.top.feed.title;
  ...
  _buildNewSection(HomeProvider homeProvider) {
    return ListView.builder(
      ...
      itemCount: homeProvider?.recent?.feed?.entries?.length ?? 0,
      itemBuilder: (BuildContext context, int index) {
        Entry entry = homeProvider.recent.feed.entries[index];
